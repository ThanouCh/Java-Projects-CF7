...
public class Project01 {
    ...
    public static void main(String[] args) {
        try (Scanner in = new Scanner(new File("C:/tmp/numbers.txt"));
             PrintStream ps = new PrintStream("C:/tmp/numbersout.txt", StandardCharsets.UTF_8)) {
    ...
    public static boolean sameTen(int[] arr, int threshold) {
        int[] ten = new int[5]; //Δημιουργούμε έναν πίνακα για να μετρήσουμε τις δεκάδες
    ...
    public static boolean sameEnding(int[] arr, int threshold) {
        int[] endings = new int[10];        //Πίνακας για μέτρηση συχνότητας των ληγόντων (0 εως 9)

        for (int num : arr) {
            endings[num % 10]++;            // Υπολογίζει τον λήγοντα του αριθμού και αυξάνει τη συχνότητά του.
        }
